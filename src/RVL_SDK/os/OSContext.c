...
asm int OSSwitchFiberEx(register u32 r3, register u32 r4, register u32 r5, register u32 r6, register u32 pc, register u32 newsp) {
#ifdef __MWERKS__
    // clang-format off
    nofralloc
    mflr    r0
...
void __OSContextInit() {
    ...
    __OSFPUContext = NULL;
    DB_PRINT("FPU-unavailable handler installed\n");
}
